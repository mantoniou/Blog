---
title: Forecasting GDP in the eurozone, using Eurostat dataset
author: ''
date: '2018-08-26'
...
A seasonal plot is used below to investigate seasonality.
...
It is a scatterplot between the time series and the lagged values of the time series. 
...
Below there is an autocorrelation function plot. It will indicate to us
if there are significant autocorrelations in the time series.
...
We can also use the Ljung-Box test to test if the time series is white noise. Below 
